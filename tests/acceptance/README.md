...
| PROC-017 | A live attachment immediately flushes both initial and later output batches without requiring user input or a newline, including a one-byte partial write followed by delayed partial output. | Step 2A |
